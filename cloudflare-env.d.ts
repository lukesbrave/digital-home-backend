/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 47752c24b6d47d293bb5083f35d55f36)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 nodejs_compat
// NOTE: wrangler types now also emits a `GlobalProps { mainModule: typeof
// import("./worker") }` block — it is deliberately removed here, because that
// import drags the excluded worker.ts (and its not-yet-generated
...
declare namespace Cloudflare {
	interface Env {
		...
		// wrangler emits Service<typeof import("./worker").default> here; kept
		// as Fetcher for the same reason GlobalProps is removed above.
		WORKER_SELF_REFERENCE: Fetcher;
		FRONTEND_WORKER: Fetcher /* digital-home-frontend */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_BASE" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "DIGITAL_HOME_URL" | "NEXT_PUBLIC_DIGITAL_HOME_URL" | "API_SECRET_KEY" | "API_SIGNATURE_REQUIRED" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "RESEND_API_KEY" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CALCOM_WEBHOOK_SECRET" | "CALCOM_API_KEY">> {}
}
